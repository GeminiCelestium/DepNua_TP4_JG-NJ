...
namespace ModernRecrut.MVC.Controllers.Tests
{
    public class PostulationControllerTests
    {
        ...
        public async Task Postulation_POST_PostulationValide_Retourne_RedirectToAction()
        {
            ...
            var postulationController = new PostulationController(mockGestionEmploisServiceProxy.Object, mockWebHostEnvironement.Object, mockGestionPostulationServiceProxy.Object, mockUserManager.Object, mockGestionDocumentsService.Object, mockLogger.Object);
